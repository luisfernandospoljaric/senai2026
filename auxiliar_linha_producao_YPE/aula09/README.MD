...
### 5. SOMA.SE e MÉDIA.SE
Total dos equipamentos de informática e a média.

### 6. SOMA.SE e MÉDIA.SE
Valor total dos Movéis e a média.


### 4. Desafio Extra (Misturando funções)
